...
dlgbox = questdlg('This will replace your existing simulation with the simulation required to generate this figure. This may take up to a few minutes. Proceed?');
...
ui.update_axes(sim,gr); %repopulate interface
